...
@RequestMapping(path = "invoice/{invoice-id}")
public class InvoiceLineController {
  ...
  //#region Get ---------------------------------------------------------------
  @Operation(summary = "Get invoice lines", description = "Get all invoicelines for an invoice.")
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<ResultDto<List<InvoiceLineDto>>> getInvoiceLines(@PathParam("invoice-id") Long invoiceId) {
  ...
  public ResponseEntity<ResultDto<InvoiceLineDto>>
    createInvoiceLine(@PathParam("invoice-id") Long invoiceId, @RequestBody InvoiceLineDto item) {
